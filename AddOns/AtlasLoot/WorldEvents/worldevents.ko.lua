-- 수정라인
-- { 0, "INV_Holiday_Christmas_Present_01", "=q6=누가 살짝 흔들어 본 선물", "" },
-- { 0, "INV_Holiday_Christmas_Present_01", "=q6=화려하게 포장된 선물꾸러미", "" }, 
-- { 0, "INV_Holiday_Christmas_Present_01", "=q6=축제 선물", "" },
-- { 0, "INV_Holiday_Christmas_Present_01", "=q6=굴뚝나무 목장조합 특별 선물", "" },
-- { 0, "INV_Holiday_Christmas_Present_01", "=q6=굴뚝나무 목장조합", "" },
-- { 0, "INV_Misc_LuckyMoneyEnvelope", "=q6=행운의 붉은 봉투", "" },
-- { 0, "INV_Box_02",  "=q6=달의 축제 폭죽 세트", "=ds=#m35#" },
-- { 0, "INV_Jewelry_Talisman_13", "=q6=발자폰", "=q1=스트라솔름" },
-- { 0, "INV_Jewelry_Talisman_13", "=q6=군주 블랙우드", "=q1=스칼로맨스" },
-- { 0, "INV_Jewelry_Talisman_13", "=q6=레반치온", "=q1=혈투의 전장" },
-- { 0, "INV_Jewelry_Talisman_13", "=q6=냉소의 영혼", "=q1=붉은십자군 수도원 - 묘지" },
-- { 0, "INV_Jewelry_Talisman_13", "=q6=살육의 괴물", "=q1=그림자송곳니 성채" },
-- { 0, "INV_Jewelry_Talisman_13", "=q6=귀부인 팔데리스", "=q1=가시덩굴 구릉" },
