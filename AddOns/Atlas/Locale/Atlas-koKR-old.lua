...
ATLAS_DDL_TRANSPORT_ROUTES = "이동 경로";
...
--************************************************
	...
	["Armory"] = "무기고";
	["Cathedral"] = "대성당 "; ["Cath"] = "Cath";
	["Graveyard"] = "묘지"; ["GY"] = "GY";
	["Library"] = "도서관"; ["Lib"] = "Lib";
	["Sunken Temple"] = "아탈학카르 신전"; ["ST"] = "ST";
	...
	["Arcane Container"] = "마법 단지";
	["Argent Dawn"] = "은빛 여명회";
	["Arms Warrior"] = "무기 전사";
	["Basement"] = "최하부";
	["Battleground Maps"] = "전장 지도";
	...
	["Fourth Stop"] = "네번째 중지";
	["Horde Leveling Guide"] = "호드 레벨링 가이드";
	["Alliance Leveling Guide"] = "얼라이언스 레벨링 가이드";
	["Holy Paladin"] = "신성 성기사";
	["Holy Priest"] = "신성 사제";
	["Horde"] = "호드";
	["Hunter"] = "사냥꾼";
	...
	["Warlock"] = "흑마법사";
	["Warrior"] = "전사";
	--Instance names and acronyms l
	["Blackfathom Deeps"] = "검은 심연의 나락"; ["BFD"] = "BFD";
	["Blackrock Depths"] = "검은바위 나락"; ["BRD"] = "BRD";
	["Blackrock Spire"] = "검은바위 첨탑"; ["LBRS"] = "LBRS"; ["UBRS"] = "UBRS";
	["Blackwing Lair"] = "검은날개 둥지"; ["BWL"] = "BWL";

	["Dire Maul"] = "혈투의 전장"; ["DME"] = "DME"; ["DMN"] = "DMN"; ["DMW"] = "DMW";
	["Gnomeregan"] = "놈리건"; ["Gnome"] = "Gnome";

	["Lower Blackrock Spire"] = "검은바위 첨탑 하층";
	["Maraudon"] = "마라우돈"; ["Mara"] = "Mara";
	["Molten Core"] = "화산 심장부"; ["MC"] = "MC";
	["Naxxramas"] = "낙스라마스"; ["Nax"] = "Nax";
	["Onyxia's Lair"] = "오닉시아의 둥지"; ["Ony"] = "Ony";
	["Ragefire Chasm"] = "성난 불길 협곡"; ["RFC"] = "RFC";
	["Razorfen Downs"] = "가시덩굴 구릉"; ["RFD"] = "RFD";
	["Razorfen Kraul"] = "가시덩굴 우리"; ["RFK"] = "RFK";
	["Ruins of Ahn'Qiraj"] = "안퀴라즈 폐허"; ["AQ20"] = "AQ20";
	["Scarlet Monastery"] = "붉은십자군 수도원"; ["SM"] = "SM"; ["SM Lib"] = "SM Lib"; ["SM Arm"] = "SM Arm"; ["SM Cath"] = "SM Cath"; ["SM GY"] = "SM GY";
	["Scholomance"] = "스칼로맨스"; ["Scholo"] = "Scholo";
	["Shadowfang Keep"] = "그림자송곳니 성채"; ["SFK"] = "SFK";
	["Stratholme"] = "스트라솔름"; ["Strat"] = "Strat";

	["Temple of Ahn'Qiraj"] = "안퀴라즈 사원"; ["AQ40"] = "AQ40";
	["The Deadmines"] = "죽음의 폐광"; ["DM"] = "DM";
	["The Stockade"] = "스톰윈드 지하감옥"; ["Stocks"] = "Stocks";
	["Uldaman"] = "울다만"; ["Uld"] = "Uld";
	["Upper Blackrock Spire"] = "검은바위 첨탑 상층";
	["Wailing Caverns"] = "통곡의 동굴"; ["WC"] = "WC";
	["Zul'Farrak"] = "줄파락"; ["ZF"] = "ZF";
	["Zul'Gurub"] = "줄구룹"; ["ZG"] = "ZG";
	
	--Continents
	["Eastern Kingdoms"] = "동부왕국 던전 지역";
	["Kalimdor"] = "동부왕국 던전 지역";
	
	--Outdoor zones, Locations
	["Ashenvale"] = "잿빛 골짜기";
	["Badlands"] = "황야의 땅";
	["Blackrock Mountain"] = "검은바위 산"; ["BRM"] = "BRM";
...
--************************************************
	...
	["Oggleflint <Ragefire Chieftain>"] = "오글플린트 <성난불길 일족 족장>";
	...
	["Lord Cobrahn <Fanglord>"] = "군주 코브란 <송곳니 군주>";
	["Lady Anacondra <Fanglord>"] = "여군주 아나콘드라 <송곳니 군주>";
	["Kresh"] = "크레쉬";
	["Lord Pythas <Fanglord>"] = "군주 피타스 <송곳니 군주>";
	["Skum"] = "스쿰";
	["Lord Serpentis <Fanglord>"] = "군주 서펜티스 <송곳니 군주> (위층)";
	...
	["Argent Guard Thaelrid <The Argent Dawn>"] = "은빛경비병 타엘리드";
	["Gelihast"] = "겔리하스트";
	...
	["Roogug"] = "루구그";
	["Aggem Thorncurse <Death's Head Prophet>"] = "아겜 쏜커스 <죽음의 머리교 예언자>";
	["Death Speaker Jargba <Death's Head Captain>"] = "죽음예언자 잘그바 <죽음의 머리교 우두머리>";
	["Overlord Ramtusk"] = "대군주 램터스크";
	["Razorfen Spearhide"] = "가시덩굴 가시근위병";
	["Agathelos the Raging"] = "흉포한 아가테로스";
	["Blind Hunter"] = "장님 사냥꾼";
	["Charlga Razorflank <The Crone>"] = "서슬깃 차를가 <대모>";
	...
	["Antu'sul <Overseer of Sul>"] = "안투술 <술의 우두머리>";
	...
	["Noxxion"] = "녹시온";
	["Razorlash"] = "칼날채찍";
	["Maraudos <The Fourth Khan>"] = "마라우도스 <제4대 칸>";
	...
	["Stomper Kreeg <The Drunk>"] = "천둥발 크리그 <주정뱅이>";
	...
	["Ouro"] = "아우로";
	["C'Thun"] = "쑨";
	["Andorgos <Brood of Malygos>"] = "안도르고스 <말리고스 혈족>";
	["Vethsera <Brood of Ysera>"] = "베스세라 <이세라 혈족>";
	["Kandrostrasz <Brood of Alexstrasza>"] = "칸드로스트라즈 <알렉스트라자 혈족>";
	["Arygos"] = "아리고스";
	["Caelestrasz"] = "캘레스트라즈";
...
--****************************
	...
	["Commander Gor'shak <Kargath Expeditionary Force>"] = "사령관 고르샤크 <카르가스 원정대>";
	["Marshal Windsor"] = "치안대장 윈저";
	["High Interrogator Gerstahn <Twilight's Hammer Interrogator>"] = "대심문관 게르스탄 <황혼의 망치단 심문관>";
	["Ring of Law"] = "법의 심판장";
	["Anub'shiah"] = "아눕쉬아";
	["Eviscerator"] = "적출자";
	...
	["Gnashjaw <Malgen Longspear's Pet>"] = "갈기턱 <말겐 롱스피어의 소환수>";
	["Korv"] = "코르브";
	["Rezznik"] = "레즈닉";
	["Rotfang"] = "썩은송곳니";
	...
	["Fineous Darkvire <Chief Architect>"] = "파이너스 다크바이어 <선임건축가>";
	...
	["Lokhtos Darkbargainer <The Thorium Brotherhood>"] = "로크토스 다크바게이너 <토륨 대장조합>";
	...
	["Princess Moira Bronzebeard <Princess of Ironforge>"] = "공주 모이라 브론즈비어드 <아이언포지 공주>";
	["High Priestess of Thaurissan"] = "타우릿산의 대여사제";
	["The Black Forge"] = "검은 가열로";
	["Core Fragment"] = "핵 조각";
	["Overmaster Pyron"] = "멸망의 파이론";
	["BRDRogue"] = "|cfffff468도적";
	["BRDHunter"] = "|cffaad372사냥꾼";
	["BRDMage"] = "|cff68ccef마법사";
	["BRDPet"] = "|cffaad372펫";
	["BRDPriest"] = "|cffffffff사제";
	["BRDShaman"] = "|cff2773ff주술사";
	["BRDEngineer"] = "|cffc69b6d기술자";

	--Blackrock Spire (Lower) 검은바위 첨탑 (하층)
	["Vaelan"] = "벨란";
	["Warosh <The Cursed>"] = "와로쉬 <저주받은 자>";
	...
	["Bannok Grimaxe <Firebrand Legion Champion>"] = "반노크 그림액스 <횃불 부대 용사>";
	["Mother Smolderweb"] = "여왕 불그물거미";
	["Crystal Fang"] = "수정 맹독거미";
	["Urok's Tribute Pile"] = "우로크의 제물더미";
	["Urok Doomhowl"] = "우로크 둠하울";
	["Quartermaster Zigris <Bloodaxe Legion>"] = "병참장교 지그리스 <도끼 부대>";
	["Halycon"] = "할리콘";
	["Gizrul the Slavener"] = "흉포한 기즈룰";
	["Ghok Bashguud <Bloodaxe Champion>"] = "고크 배시구드 <도끼 부대 용사>";
	...
	["Jed Runewatcher <Blackhand Legion>"] = "제드 룬워처 <검은손 부대>";
	["Goraluk Anvilcrack <Blackhand Legion Armorsmith>"] = "고랄루크 앤빌크랙 <검은손 부대 갑옷제작자>";
	["Warchief Rend Blackhand"] = "대족장 렌드 블랙핸드";
	["Gyth <Rend Blackhand's Mount>"] = "기스 <렌드 블랙핸드의 탈것>";
	["Awbee"] = "아우비";
	["The Beast"] = "괴수";
	...
	["Chomper"] = "강철이빨바실리스크";
	["Clean Room"] = "깨끗한 방";
	["Tink Sprocketwhistle <Engineering Supplies>"] = "팅크 스프로켓휘슬 <기술용품 상인>";
	...
	["Herod <The Scarlet Champion>"] = "헤로드 <붉은십자군 용사>";

	--SM: Cathedral 붉은십자군 수도(대성당)
	...
	["Doctor Theolen Krastinov <The Butcher>"] = "학자 테올렌 크리스티노브";
	...
	["Rethilgore <The Cell Keeper>"] = "레실고어 <문지기>";
	...
	["Fras Siabi"] = "프라스 샤비";
	["Atiesh <Hand of Sargeras>"] = "아티쉬 <살게라스의 하수인>";
	["Balzaphon"] = "발자폰";
	...
	["Rhahk'Zor <The Foreman>"] = "라크조르 <감독관>";
	["Miner Johnson"] = "광부 존슨";
	["Sneed <Lumbermaster>"] = "스니드 <작업 감독관>";
	["Sneed's Shredder <Lumbermaster>"] = "스니드의 벌목기 <작업 감독관>";
	["Gilnid <The Smelter>"] = "길니드 <제련공>";
	["Defias Gunpowder"] = "데피아즈단 화약";
	["Captain Greenskin"] = "선장 그린스킨";
	["Edwin VanCleef <Defias Kingpin>"] = "에드윈 밴클리프 <데피아즈단 두목>";
	["Mr. Smite <The Ship's First Mate>"] = "미스터 스마이트 <일등항해사>";
	["Cookie <The Ship's Cook>"] = "주방장 쿠키";
	...
	["Atal'alarion <Guardian of the Idol>"] = "아탈알라리온 <신상의 수호신>";
	["Dreamscythe"] = "드림사이드";
	["Weaver"] = "위버";
	...
	["Annora <Enchanting Trainer>"] = "안노라 <전문 마법부여사>";
	["Ancient Stone Keeper"] = "고대 바위 문지기";
	["Galgann Firehammer"] = "갈간 파이어해머";
	["Tablet of Will"] = "결의의 서판";
	["Shadowforge Cache"] = "어둠괴철로 금고";
	["Grimlok <Stonevault Chieftain>"] = "그림로크 <바위동굴 일족 족장>";
	["Archaedas <Ancient Stone Watcher>"] = "아카에다스 <고대의 바위감시자>";
	...
	["Highlord Mograine <The Ashbringer>"] = "대군주 모그레인";
	["Sir Zeliek"] = "젤리엑 경";
...
--************************************************
	...
	["Scarshield Quartermaster <Scarshield Legion>"] = "방패부대 병참장교 <방패 부대>";

	--Gnomeregan (Entrance) 놈리건(입구)
	["Transpolyporter"] = "순간이동기";
	["Sprok <Away Team>"] = "스프록 <원정팀>";
	["Matrix Punchograph 3005-A"] = "행렬천공기록기3005-A";
	["Namdo Bizzfizzle <Engineering Supplies>"] = "남도 비즈피즐 <기술용품 상인>";
	["Techbot"] = "첨단로봇";

	--Maraudon (Entrance) 마라우돈(입구)
	["The Nameless Prophet"] = "이름 없는 예언자";
	["Kolk <The First Kahn>"] = "콜크 <제1대 칸>";
	["Gelk <The Second Kahn>"] = "겔크 <제2대 칸>";
	["Magra <The Third Kahn>"] = "마그라 <제3대 칸>";
	["Cavindra"] = "카빈드라";
	...
	["Boahn <Druid of the Fang>"] = "보안 <송곳니의 드루이드>";
	["Above the Entrance:"] = "입구 위:";
	["Ebru <Disciple of Naralex>"] = "에브루 <나랄렉스의 신도>";
	["Nalpak <Disciple of Naralex>"] = "날팍 <나랄렉스의 신도>";
	["Kalldan Felmoon <Specialist Leatherworking Supplies>"] = "칼단 펠문 <특수 가죽용품 상인>";
	["Waldor <Leatherworking Trainer>"] = "왈도르 <전문 가죽세공인>";
	...
	["Alterac Valley"] = "알터랙 계곡"; ["AV"] = "AV";
	["Arathi Basin"] = "아라시 분지"; ["AB"] = "AB";
	["Arathi Highlands"] = "아라시 고원";
	["Ashenvale"] = "잿빛 골짜기";
	["Eastern Kingdoms"] = "동부왕국";
	["Eye of the Storm"] = "폭풍의 눈 "; ["EotS"] = "EotS";
	["Hillsbrad Foothills"] = "힐스브래드 구릉지";
	["Kalimdor"] = "칼림도어";
	["Netherstorm"] = "황천의 폭풍 ";
	["Outland"] = "아웃랜드";
	["The Barrens"] = "불모의 땅";
	["Warsong Gulch"] = "전쟁노래 협곡"; ["WSG"] = "WSG";
	...
	["Dun Baldar"] = "던 발다르";
	["Vanndar Stormpike <Stormpike General>"] = "반다르 스톰파이크 <스톰파이크 사령관>";
	...
	["Dirk Swindle <Bounty Hunter>"] = "더크 스윈들 <현상금 사냥꾼>";
	["Athramanis <Bounty Hunter>"] = "아스라마니스 <현상금 사냥꾼>";
	["Lana Thunderbrew <Blacksmithing Supplies>"] = "라나 썬더브루 <대장용품 상인>";
	["Stormpike Aid Station"] = "Stormpike Aid Station";
	["Stormpike Stable Master <Stable Master>"] = "스톰파이크 야수 관리인 <야수 관리인>";
	["Stormpike Ram Rider Commander"] = "스톰파이크 산양기병대 지휘관";
	["Svalbrad Farmountain <Trade Goods>"] = "슈발브라트 파마운틴 <직업용품 상인>";
	["Kurdrum Barleybeard <Reagents & Poison Supplies>"] = "쿠르드룸 발리비어드 <마법 재료 및 독극물 상인>";
	["Stormpike Quartermaster"] = "스톰파이크 병참장교";
	["Jonivera Farmountain <General Goods>"] = "요니베라 파마운틴 <일용품 상인>";
	["Brogus Thunderbrew <Food & Drink>"] = "브로구스 썬더브루 <식료품 상인>";
	...
	["Gaelden Hammersmith <Stormpike Supply Officer>"] = "가엘덴 해머스미스 <스톰파이크 병참장교>";
	...
	["Captain Balinda Stonehearth <Stormpike Captain>"] = "부대장 발린다 스톤하스 <스톰파이크 부대장>";
	...
	["Drek'Thar <Frostwolf General>"] = "드렉타르 <서리늑대 사령관>";
	["Duros"] = "듀로스";
	["Drakan"] = "드라칸";
	...
	["Captain Galvangar <Frostwolf Captain>"] = "부대장 갈반가르 <서리늑대 부대장>";
	...
	["Frostwolf Stable Master <Stable Master>"] = "서리늑대 야수 관리인 <야수 관리인>";
	...
	["Tauren Leveling Guide"] = "타우렌 레벨링 가이드";
	["Undead Leveling Guide"] = "언데드 레벨링 가이드";
	["Troll/Orc Leveling Guide"] = "트롤/오크 레벨링 가이드"; 
	["Horde Leveling Guide"] = "호드 레벨링 가이드";
	["Human Leveling Guide"] = "인간 레벨링 가이드";
	["Night Elf Leveling Guide"] = "나이트 엘프 레벨링 가이드";
	["Gnome/Dwarf Leveling Guide"] = "놈/드워프 레벨링 가이드"; 
	["Alliance Leveling Guide"] = "언라이언스 레벨링 가이드";
};
